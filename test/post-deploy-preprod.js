...
describe('Post-Deploy Tests on Preprod', () => {
  it('Purge a blog post', async () => {
    ...
    console.log(`Trying https://preprod.adobeioruntime.net/${getbaseurl()}?host=theblog--adobe.hlx.page&xfh=blog.adobe.com&path=/en/2020/08/14/6-ways-ta-adapt-advance-your-business-during-pandemic.html`);
